...
export default {
    ...
    watch: {
        ...
        longitude(newVal) {
            this.selectedPoint.longitude = newVal;
        },
        latitude(newVal) {
            this.selectedPoint.latitude = newVal;
        },
    },
    ...
    methods: {
        ...
        confirmLocation() {
            ...
            // 触发 update-location 事件，将新的经纬度传递给父组件
            this.$emit('update-location', {
                longitude: this.tmpLongitude,
                latitude: this.tmpLatitude,
                locationName: this.tmpLocationName,
            });
        ...
        getWindTurbines() {
            fetch(`http://1.14.204.181:5000/get_datasets`, {
                ...
                .then(data => {
                    ...
                    this.points.push({
                        name: 'selectedPoint',
                        value: [this.selectedPoint.longitude, this.selectedPoint.latitude],
                        itemStyle: this.getItemStyle('selectedPoint')
                    });
        ...
        initCharts() {
            ...
            this.chart.on('click', (e) => {
                //打印tmpPoint
                console.log("tmpPPP", this.tmpPoint)

                //打印现在的selectedPoint
                console.log("selectedPPP", this.selectedPoint)
